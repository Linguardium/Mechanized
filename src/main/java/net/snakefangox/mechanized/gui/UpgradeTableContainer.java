...
import static net.snakefangox.mechanized.MRegister.UPGRADE_TABLE_SCREEN_HANDLER;
...
public class UpgradeTableContainer extends SyncedGuiDescription {
	...
	public UpgradeTableContainer(int syncID, PlayerInventory playerInventory) {
		super(UPGRADE_TABLE_SCREEN_HANDLER, syncID, playerInventory, new UpgradeTableInv(), new ArrayPropertyDelegate(0));
	...
	public static class UpgradeListener implements ScreenHandlerListener {
		...
		@Override
		public void onPropertyUpdate(ScreenHandler container, int propertyId, int i) {
		}
	...
	public static class UpgradeTableScreen extends CottonInventoryScreen<UpgradeTableContainer> {
		public UpgradeTableScreen(UpgradeTableContainer container, PlayerInventory playerInventory, Text text) {
